This folder contains all core corpus samples annotated by the human annotator with the pseudonym "jupiter" in XMI format, as used by the annotation framework DKPro (https://dkpro.github.io/).
