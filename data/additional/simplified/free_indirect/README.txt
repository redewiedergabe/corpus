...
This subcorpus was created to generate training data for the automatic recognizers developed by project REDEWIEDERGABE. The annotation system is strongly reduced, only specifying the type free indirect (without medium and attributes). Frame, intExpr and speaker are not annotated.
...
NOTE: As instances of free indirect that were not detected by the automatic recognizer were never presented to the humans, this corpus most likely contains false negatives (unlabeled free indirect instances)!
