This folder contains fictional and non-fictional text samples (annotated by single annotators) in XMI-format, as used by the annotation framework DKPro (https://dkpro.github.io/).
