...
This version of the corpus consists of XMI files as used by the [DKPro framework](https://dkpro.github.io/dkpro-core/). Each file contains the text of one sample. XMI was the working format of project REDEWIEDERGABE and the basis for the [XML](xml_format.md) and [column-based text](column_based_text_format.md) formats. 
...
The XMI files are compatible with the annotation tool [ATHEN](https://gitlab2.informatik.uni-wuerzburg.de/kallimachos/Athen) (developed by Markus Krug in the [Kallimachos project](http://kallimachos.de)) and its [STWR view](https://gitlab2.informatik.uni-wuerzburg.de/kallimachos/Athen/blob/master/de.uniwue.mk.athen/releng/de.uniwue.mk.athen.docu/STWRView.md) (developed by Tanja Tu) which have been used in project REDEWIEDERGABE. This tool is freely available for download. Please use the type system file `rwTypesystem_stwrview.xml` to display the files correctly.   
