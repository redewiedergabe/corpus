...
| [Single-annotated full texts (fictional)](data/additional/single_annotated/full_fict) |   17   | 235,493|   6,232        |[Description](resources/docs/full_texts.md) **Note**: Annotation guidelines differ slightly with respect to *speaker*   
...
| [Single-annotated free indirect full texts (fictional)](TODO) | 142 |  | 2,136 | [Description](resources/docs/freeindirect-corpus.md) **Note**: In this corpus only instances of *free indirect* representation are annotated
